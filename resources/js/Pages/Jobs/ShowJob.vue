...
import JobCompanyDetails from "@/components/Jobs/JobCompanyDetails.vue";
import {ref} from "vue";
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between w-full items-end mt-16">
                <Link
        ...
        <main class="mx-4 pb-4">
            <div class="max-w-7xl mx-auto bg-white rounded-lg lg:flex p-4">
                ...
                <JobCompanyDetails :post="post" :isACModalVisible="isACModalVisible" @update:isACModalVisible="updateACModalVisibility"/>
            </div>
